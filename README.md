...
Students will use IntelliJ IDEA and Android Studio to create Java applications. Students will deploy the applications onto live servers. Students will install Android applications onto their own phones and have the apps communicate with AWS using Amplify.
...
* Daily Journals: Each daily journal will become available each morning, is due by the start of lecture, and locks at midnight on that day.
