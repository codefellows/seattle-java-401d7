...
* [Spring Guide on security](https://spring.io/guides/gs/securing-web/): Goes through the basics of configuration/`WebSecurityConfig`, but not through creating an actual user model/using Bcrypt.

## Step 1: set up a user model and repo

## Step 2: create a controller for that model

Make sure the controller correctly saves new users with a password that's been hashed by Bcrypt.
